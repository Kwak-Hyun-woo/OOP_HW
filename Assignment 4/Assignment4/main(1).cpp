...
void single_round_simultation() {
	...
	Environment env(MAP_SIZE, N_FRUITS, L_SNAKES, MAX_TURNS);                     // ¿øº»
...
int main(void) {
    ...
    //
    //for (int i = 0; i < 200; ++i) {
    //    single_round_simultation<MyPlayer, MyPlayer_init>();
    //}
    ...
    // Sample game 3
    //multiple_round_simultation<MyPlayer, MyPlayer_init>();

    //multiple_round_simultation<MyPlayer, ProfNeverDie>();

    //multiple_round_simultation<ProfFruitTaker, ProfNeverDie>();
